...
class LaneDetector:
    ...
    def draw_lane(self, orignal_image, binary_warped, filtered_binary):    
        ...
        rec_window_img = np.dstack((binary_warped, binary_warped, binary_warped))*255
        ...
        if self.detected:
            ...
            for window in range(nwindows):
                ...
                right_lane_inds.append(good_right_inds)
                  ...
                  #drawing windows 
                cv2.rectangle(rec_window_img, (win_xleft_low, win_y_low), (win_xleft_high, win_y_high), (0, 255, 0), 2)
                cv2.rectangle(rec_window_img, (win_xright_low, win_y_low), (win_xright_high, win_y_high), (0, 255, 0), 2)
